...
public interface Folder extends Resource, Iterable<Resource> {
     ...
     * @throws com.wavemaker.studio.common.io.exception.ResourceDoesNotExistException if the resource does not exist
     ...
     * @throws com.wavemaker.studio.common.io.exception.ResourceTypeMismatchException if the an existing resource exits that is not a folder
     */
