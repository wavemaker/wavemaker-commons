...
public abstract class StringUtils {
    ...
    static {
        ...
        JAVA_KEYWORDS.add("character");
        JAVA_KEYWORDS.add("class");
        JAVA_KEYWORDS.add("compiler");
        ...
        JAVA_KEYWORDS.add("threadgroup");
        JAVA_KEYWORDS.add("throw");
        JAVA_KEYWORDS.add("throwable");
