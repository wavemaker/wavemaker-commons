...
import com.wavemaker.studio.common.io.FilteredResources;
import com.wavemaker.studio.common.io.Folder;
import com.wavemaker.studio.common.io.Resource;
import com.wavemaker.studio.common.io.ResourceFilter;
import com.wavemaker.studio.common.io.ResourceFilterContext;
import com.wavemaker.studio.common.io.Resources;
import com.wavemaker.studio.common.io.ResourcesCollection;
...
public class FilteredResourcesTest {
    ...
    private void assertMatches(Resources<File> actual, File... expected) {
        ...
        for (File file : expected) {
            assertThat(iterator.next(), Matchers.is(file));
        }
